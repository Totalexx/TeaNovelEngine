...
import com.rafaskoberg.gdx.typinglabel.effects.PauseEffect;
...
public class TypingConfig {
    ...
    public static float DEFAULT_SPEED_PER_CHAR = 0.025f;
    ...
    static {
        ...
        registerEffect("PAUSE", "ENDPAUSE", PauseEffect.class);
